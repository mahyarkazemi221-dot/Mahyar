...
DEFAULT_CONFIG = {
    "host_usernames": ["1lonely_boy1"],
    "admin_usernames": ["1lonely_boy1"],
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "6a226bb5062245bc0201c290")
    api_token = os.getenv("API_TOKEN", "1d9da79340b5fc0f4ce48cad993fcd239fcf2f2bda348f34d2721e7d80e87539")
